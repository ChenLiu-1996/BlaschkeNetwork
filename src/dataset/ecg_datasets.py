...
class ECGDataset(Dataset):
    def __init__(self, data_path, csv_file, mode='train', dataset_name='ptbxl'):
        '''
        Args:
...
def get_ecg_dataset(data_path, csv_path, mode='train', dataset_name='ptbxl', ratio=100):
    ratio = int(ratio)
    ...
    dataset = ECGDataset(data_path, csv, mode=mode, dataset_name=dataset_name)
