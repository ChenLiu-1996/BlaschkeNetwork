...
if __name__ == '__main__':
    ...
    model_save_path = f'../checkpoints/cifar10/BN1d_{args.layers}_lr_{args.lr}_epoch_{args.num_epoch}-seed_{args.random_seed}/model_best_val_acc.ckpt'
    results_dir = f'../results/cifar10/BN1d_{args.layers}_lr_{args.lr}_epoch_{args.num_epoch}-seed_{args.random_seed}/'
