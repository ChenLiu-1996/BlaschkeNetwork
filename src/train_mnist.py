...
from models.BDN import BDNetworkImage
...
if __name__ == '__main__':
    ...
    model_save_path = f'../checkpoints/mnist/BDN_{args.layers}_lr_{args.lr}_epoch_{args.num_epoch}-seed_{args.random_seed}/model_best_val_acc.ckpt'
    results_dir = f'../results/mnist/BDN_{args.layers}-lr_{args.lr}_epoch_{args.num_epoch}-seed_{args.random_seed}/'
    ...
    image_channels = 1
    model = BDNetworkImage(layers_hidden=[image_channels, *args.layers])
